...
To document search process, at the minimum generate an 'evidence matrix'. The evidence matrix as a synthesis tool was formally pioneered by the evidence-based synthesis expert for public health [Joseph Lau](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(12)60177-9/fulltext). It has changed significantly, but it is a form of summary table highlighting frequencies of search terms to illuminate the frequency of the *conjunction* of ideas.
