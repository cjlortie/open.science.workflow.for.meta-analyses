...
#library setup####
library(tidyverse)
library(plotrix) #for quick s.e. calculations
...
#print meta-statistical model you fit
...
#explore bias
funnel(m) #plot to explore distribution of effect size measures, asymmetry suggests bias in the field of research
...
#and yes, you can do meta-statistics like a GLM with interaction terms
