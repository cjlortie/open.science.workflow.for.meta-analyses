...
###Workflow
**Purpose**  
To examine meta-analysis as a tool for scientific synthesis. This workshop will include a workflow from primary literature compilation to meta-analysis.

**To read or not to read**  
Meta-analysis is a powerful scientific synthesis tool.
The first step to be able to critically read and assess their relative merits because of their increasing frequency in most domains of evidence-based inquiry. Here is a short [how-to read meta-analyses](http://onlinelibrary.wiley.com/doi/10.1002/jrsm.1109/abstract).
...
Open science publication or open pre-print <br>
